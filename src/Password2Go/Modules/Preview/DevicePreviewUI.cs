...
{
    public partial class DevicePreviewUI : UserControl, IPreviewUI
    {
        ...
        public DevicePreviewUI()
        {
            ...
            rtbAddress.AddElementToTextBox(_copyImage, rbCopyAddressL_Click);
        ...
        public void Bind(object previewModel, bool updateView = true)
        {
            ...
            DevicePreviewViewModel model = previewModel as DevicePreviewViewModel;
        ...
        public void UpdateView(DevicePreviewViewModel model)
        {
        ...
        private void rbCopyAddressL_Click(object sender, EventArgs e)
        {
            try
            {
    ...
    public class DevicePreviewViewModel : BasePreviewViewModel
    {
